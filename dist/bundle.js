...
function AppConfig($httpProvider, envServiceProvider, $urlRouterProvider, $sceDelegateProvider) {
  ...
  envServiceProvider.config({
    domains: {
      ...
      production: ['production.eventosdobem.com.br', 'eventodobem.com.br', 'eventosdobem.com', 'eventodobem.com', 'eventosdobem.com.br']
    ...
    vars: {
      ...
      production: {
        ...
        staticUrl: 'https://production.eventosdobem.com.br/',
        accept: "application/vnd.api.v1+json",
        contenttype: "application/json",
        token: "0IphXRqJZe9wkMYQJJBp2X0TsVjQyg",
